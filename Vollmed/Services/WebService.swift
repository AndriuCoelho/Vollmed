...
struct WebService {
    ...
    func logoutPatient() async throws -> Bool {
        ...
        let (test, response) = try await URLSession.shared.data(for: request)
    ...
    func loginPatient(email: String,
    ...
    func cancelAppointment(appointmentID: String,
                           reasonToCancel: String) async throws -> Bool {
    ...
    func rescheduleAppointment(appointmentID: String,
